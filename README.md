...
I'm focusing on building a strong foundation. My current stack includes:

* **☕ Java:** Learning the fundamentals of Object-Oriented Programming (OOP) for my core courses.
* **🐍 Python:** Using it for scripting, personal projects, and exploring data structures.
* **📚 Actively Studying:** Data Structures & Algorithms, and discrete mathematics.

### 💻 My Setup & Tools

I believe a great setup inspires great work. I've spent a lot of time crafting my personal learning environment, and it's always a work-in-progress!
